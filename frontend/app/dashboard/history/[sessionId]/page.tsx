...
export default async function DetailPage({ params }: { params: { sessionId: string } }) {
  ...
  // Debug logging
  console.log(`Detail page loaded for session: ${sessionId}, user: ${userId}`);
  ...
  return (
    <div className="w-full min-h-screen bg-black relative">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute bottom-1/3 right-1/6 w-80 h-80 bg-red-600/5 rounded-full mix-blend-multiply filter blur-3xl animate-pulse animation-delay-2s"></div>      </div>
