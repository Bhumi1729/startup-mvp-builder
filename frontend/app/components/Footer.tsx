            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <div className="flex items-center space-x-3 group">
                <div className="relative">
                  <div className="w-12 h-12 bg-gradient-to-br from-pink-600 via-red-600 to-orange-600 rounded-xl flex items-center justify-center transform group-hover:scale-110 transition-all duration-300 shadow-lg shadow-pink-500/40">
                ...
                <div className="flex flex-col">
                  ...
                  <span className="text-sm text-gray-400 font-medium">Build smarter, launch faster.</span>
                </div>
              </div>
                ...
                <div className="flex flex-col sm:flex-row gap-3">
                  <div className="relative flex-1 max-w-sm">
                    <input
                      ...
                      className="w-full px-4 py-3 bg-gray-900/50 border border-gray-700/50 rounded-xl text-white placeholder-gray-500 focus:outline-none focus:border-pink-500/50 focus:ring-2 focus:ring-pink-500/20 transition-all duration-300 backdrop-blur-xl"
                      required
                    />
              ...
              <div className="flex flex-col space-y-4">
                {socialLinks.map((social) => {
                  ...
                  return (
                    ...
                    >
                      <div className="relative">
                        <div className="p-2 bg-gray-900/50 rounded-lg border border-gray-700/50 group-hover:border-pink-500/50 transition-all duration-300 group-hover:bg-gradient-to-br group-hover:from-pink-600/20 group-hover:to-red-600/20 backdrop-blur-xl">
